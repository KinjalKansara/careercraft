...
<html lang="en">
    ...
    <head>
        ...
        <title> User Update Email & Password</title>
    ...
    <body>
        <div class="user-container">
            ...
            <div class="forform">
                <form action="/ChangeByUser" method="post" class="form"> 
                    @csrf
                        ...
                        <div class="content-2">
                            <div class="column">
                                <div class="input-box">
                                    ...
                                    <input type="" name="email" placeholder="Enter Email Address" value="{{session('email')}}">
